...
import { ShoppingCart, Package, LogOut, Pill } from "lucide-react"
...
export function BuyerLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    { name: "Order Medicines", href: "/buyer/order", icon: Pill },
    { name: "My Cart", href: "/buyer/cart", icon: ShoppingCart },
    { name: "My Orders", href: "/buyer/my-orders", icon: Package },
  ]
